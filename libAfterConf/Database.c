...
TermDef GravityTerms[] = {
	{TF_NO_MYNAME_PREPENDING, "NorthWest", 9, TT_FLAG, GRAVITY_NorthWest_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "North", 5, TT_FLAG, GRAVITY_North_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NorthEast", 9, TT_FLAG, GRAVITY_NorthEast_ID,
	 NULL}
	,
	...
	,
	{TF_NO_MYNAME_PREPENDING, "SouthWest", 9, TT_FLAG, GRAVITY_SouthWest_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "South", 5, TT_FLAG, GRAVITY_South_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "SouthEast", 9, TT_FLAG, GRAVITY_SouthEast_ID,
	 NULL}
	,
...
TermDef StyleTerms[] = {
	...
	,
	{TF_NO_MYNAME_PREPENDING, "FocusStyle", 10, TT_TEXT,
	 DATABASE_FocusStyle_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "UnfocusStyle", 12, TT_TEXT,
	 DATABASE_UnfocusStyle_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StickyStyle", 11, TT_TEXT,
	 DATABASE_StickyStyle_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoIconTitle", 11, TT_FLAG,
	 DATABASE_NoIconTitle_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "IconTitle", 9, TT_FLAG, DATABASE_IconTitle_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Focus", 5, TT_FLAG, DATABASE_Focus_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoFocus", 7, TT_FLAG, DATABASE_NoFocus_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoTitle", 7, TT_FLAG, DATABASE_NoTitle_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Title", 5, TT_FLAG, DATABASE_Title_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoHandles", 9, TT_FLAG, DATABASE_NoHandles_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Handles", 7, TT_FLAG, DATABASE_Handles_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoButton", 8, TT_INTEGER,
	 DATABASE_NoButton_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Button", 6, TT_INTEGER, DATABASE_Button_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "WindowListSkip", 14, TT_FLAG,
	 DATABASE_WindowListSkip_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "WindowListHit", 13, TT_FLAG,
	 DATABASE_WindowListHit_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "CirculateSkip", 13, TT_FLAG,
	 DATABASE_CirculateSkip_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "CirculateHit", 12, TT_FLAG,
	 DATABASE_CirculateHit_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StartIconic", 11, TT_FLAG,
	 DATABASE_StartIconic_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StartNormal", 11, TT_FLAG,
	 DATABASE_StartNormal_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Layer", 5, TT_INTEGER, DATABASE_Layer_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StaysOnTop", 10, TT_FLAG,
	 DATABASE_StaysOnTop_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StaysPut", 8, TT_FLAG, DATABASE_StaysPut_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StaysOnBack", 11, TT_FLAG,
	 DATABASE_StaysOnBack_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "AvoidCover", 10, TT_FLAG,
	 DATABASE_AvoidCover_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "AllowCover", 10, TT_FLAG,
	 DATABASE_AllowCover_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "VerticalTitle", 13, TT_FLAG,
	 DATABASE_VerticalTitle_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HorizontalTitle", 15, TT_FLAG,
	 DATABASE_HorizontalTitle_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Sticky", 6, TT_FLAG, DATABASE_Sticky_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Slippery", 8, TT_FLAG, DATABASE_Slippery_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "BorderWidth", 11, TT_INTEGER,
	 DATABASE_BorderWidth_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HandleWidth", 11, TT_INTEGER,
	 DATABASE_HandleWidth_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StartsOnDesk", 12, TT_INTEGER,
	 DATABASE_StartsOnDesk_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "ViewportX", 9, TT_INTEGER,
	 DATABASE_ViewportX_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "ViewportY", 9, TT_INTEGER,
	 DATABASE_ViewportY_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "StartsAnywhere", 14, TT_FLAG,
	 DATABASE_StartsAnywhere_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoFrame", 7, TT_FLAG, DATABASE_NoFrame_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "Frame", 5, TT_TEXT, DATABASE_Frame_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "WindowBox", 9, TT_TEXT, DATABASE_Windowbox_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "DefaultGeometry", 15, TT_GEOMETRY,
	 DATABASE_DefaultGeometry_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "OverrideGravity", 15, TT_FLAG,
	 DATABASE_OverrideGravity_ID, &GravitySyntax}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorPPosition", 14, TT_FLAG,
	 DATABASE_HonorPPosition_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoPPosition", 11, TT_FLAG,
	 DATABASE_NoPPosition_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorGroupHints", 15, TT_FLAG,
	 DATABASE_HonorGroupHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoGroupHints", 12, TT_FLAG,
	 DATABASE_NoGroupHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorTransientHints", 19, TT_FLAG,
	 DATABASE_HonorTransientHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoTransientHints", 16, TT_FLAG,
	 DATABASE_NoTransientHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorMotifHints", 15, TT_FLAG,
	 DATABASE_HonorMotifHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoMotifHints", 12, TT_FLAG,
	 DATABASE_NoMotifHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorGnomeHints", 15, TT_FLAG,
	 DATABASE_HonorGnomeHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoGnomeHints", 12, TT_FLAG,
	 DATABASE_NoGnomeHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorKDEHints", 13, TT_FLAG,
	 DATABASE_HonorKDEHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoKDEHints", 10, TT_FLAG,
	 DATABASE_NoKDEHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorExtWMHints", 15, TT_FLAG,
	 DATABASE_HonorExtWMHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoExtWMHints", 12, TT_FLAG,
	 DATABASE_NoExtWMHints_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorXResources", 15, TT_FLAG,
	 DATABASE_HonorXResources_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoXResources", 12, TT_FLAG,
	 DATABASE_NoXResources_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "FocusOnMap", 10, TT_FLAG,
	 DATABASE_FocusOnMap_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "NoFocusOnMap", 12, TT_FLAG,
	 DATABASE_NoFocusOnMap_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "LongLiving", 10, TT_FLAG,
	 DATABASE_LongLiving_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "ShortLiving", 11, TT_FLAG,
	 DATABASE_ShortLiving_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "IgnoreConfig", 12, TT_FLAG,
	 DATABASE_IgnoreConfig_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorConfig", 11, TT_FLAG,
	 DATABASE_HonorConfig_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "UseCurrentViewport", 18, TT_FLAG,
	 DATABASE_UseCurrentViewport_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "UseAnyViewport", 14, TT_FLAG,
	 DATABASE_UseAnyViewport_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "IgnoreRestack", 13, TT_FLAG,
	 DATABASE_IgnoreRestack_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "HonorRestack", 12, TT_FLAG,
	 DATABASE_HonorRestack_ID, NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "PagerHit", 10, TT_FLAG, DATABASE_PagerHit_ID,
	 NULL}
	,
	{TF_NO_MYNAME_PREPENDING, "PagerSkip", 12, TT_FLAG,
	 DATABASE_PagerSkip_ID, NULL}
	,
	ASCF_DEFINE_KEYWORD (DATABASE, TF_NO_MYNAME_PREPENDING, Fullscreen,
											 TT_FLAG, NULL),
	ASCF_DEFINE_KEYWORD (DATABASE, TF_NO_MYNAME_PREPENDING, NoFullscreen,
											 TT_FLAG, NULL),
	ASCF_DEFINE_KEYWORD (DATABASE, TF_NO_MYNAME_PREPENDING, WindowOpacity,
											 TT_INTEGER, NULL),
	{0, NULL, 0, 0, 0}
};
...
flag_options_xref StyleFlags[] = {
	...
	,
	{STYLE_VERTICAL_TITLE, DATABASE_VerticalTitle_ID,
	 DATABASE_HorizontalTitle_ID}
	,
	...
	,
	{STYLE_TRANSIENT_HINTS, DATABASE_HonorTransientHints_ID,
	 DATABASE_NoTransientHints_ID}
	,
	...
	,
	{STYLE_XRESOURCES_HINTS, DATABASE_HonorXResources_ID,
	 DATABASE_NoXResources_ID}
	,
	...
	,
	{STYLE_IGNORE_RESTACK, DATABASE_IgnoreRestack_ID,
	 DATABASE_HonorRestack_ID}
	,
	{STYLE_CURRENT_VIEWPORT, DATABASE_UseCurrentViewport_ID,
	 DATABASE_UseAnyViewport_ID}
	,
...
TermDef DatabaseTerms[] = {
	{TF_NAMED | TF_NO_MYNAME_PREPENDING, "Style", 5, TT_QUOTED_TEXT,
	 DATABASE_STYLE_ID, &StyleSyntax}
	,
	{0, NULL, 0, 0, 0}
};
...
void ParseSingleStyle (FreeStorageElem * storage, name_list * style)
{
	ConfigItem item;
	register int i;
	...
	for (; storage; storage = storage->next) {
		...
		if (ReadFlagItem
				(&(style->set_flags), &(style->flags), storage, StyleFlags))
			is_flag = True;
		if (ReadFlagItem
				(&(style->set_data_flags), NULL, storage, StyleDataFlags))
			is_flag = True;
		...
		case DATABASE_Icon_ID:
			set_string_value (&(style->icon_file), item.data.string,
												&(style->set_data_flags), STYLE_ICON);
		...
		case DATABASE_WindowOpacity_ID:
			...
			LOCAL_DEBUG_OUT ("style->window_opacity = %d",
											 style->window_opacity);
			break;
		case DATABASE_Frame_ID:
			set_string_value (&(style->frame_name), item.data.string,
												&(style->set_data_flags), STYLE_FRAME);
			if (strlen (style->frame_name) <= 0)
				clear_flags (style->set_data_flags, STYLE_FRAME);
			break;
		case DATABASE_Windowbox_ID:
			set_string_value (&(style->windowbox_name), item.data.string,
												&(style->set_data_flags), STYLE_FRAME);
...
name_list *ParseDatabaseOptions (const char *filename, char *myname)
{
	ConfigData cd;
	...
	ConfigReader =
			InitConfigReader (myname, &DatabaseSyntax, CDT_Filename, cd, NULL);
	if (!ConfigReader)
		return config;
...
name_list *string2DatabaseStyle (char *style_txt)
{
	ConfigData cd;
	ConfigDef *ConfigReader;
...
Bool ReloadASDatabase ()
{
	...
	if (configfile != NULL) {
		...
		if (list) {
			...
			show_progress ("DATABASE configuration loaded from \"%s\" ...",
										 configfile);
		} else
...
FreeStorageElem **WriteSingleStyle (name_list * style,
																		FreeStorageElem ** tail)
{
	...
	/* our name : */
	tail =
			QuotedString2FreeStorage (&DatabaseSyntax, tail, NULL, style->name,
																DATABASE_STYLE_ID);
	...
	if (d_tail != tail) {					/* checking if storage for style was actually created */
		...
		if (style->set_flags != 0)	/* that should take care of all the flags : */
			d_tail =
					Flags2FreeStorage (&StyleSyntax, d_tail, StyleFlags,
														 style->set_flags, style->flags);

		/* Icon */
		if (style->icon_file)
			if (strlen (style->icon_file) > 0)
				d_tail =
						String2FreeStorage (&StyleSyntax, d_tail, style->icon_file,
																DATABASE_Icon_ID);
		...
		for (i = 0; i < BACK_STYLES; i++) {
			if (window_style_cross[i][0] >= DATABASE_ID_START) {
				...
				if (s) {
					if (strlen (s)) ;
					d_tail =
							String2FreeStorage (&StyleSyntax, d_tail, s,
																	window_style_cross[i][0]);
				}
			}
		}
		...
		for (i = 0; i < MAX_BUTTONS; i++)
			if (style->off_buttons & (C_TButton0 << i))
				d_tail =
						Integer2FreeStorage (&StyleSyntax, d_tail, NULL, i,
		...
		if (get_flags (style->set_flags, STYLE_DEFAULT_GEOMETRY))
			d_tail =
					Geometry2FreeStorage (&StyleSyntax, d_tail,
																&(style->default_geometry),
																DATABASE_DefaultGeometry_ID);

		if (get_flags (style->set_flags, STYLE_LAYER)) {
			if (style->layer == AS_LayerBack)
				d_tail =
						Flag2FreeStorage (&StyleSyntax, d_tail,
															DATABASE_StaysOnBack_ID);
			else if (style->layer == AS_LayerNormal)
				d_tail =
						Flag2FreeStorage (&StyleSyntax, d_tail, DATABASE_StaysPut_ID);
			else if (style->layer == AS_LayerTop)
				d_tail =
						Flag2FreeStorage (&StyleSyntax, d_tail,
															DATABASE_StaysOnTop_ID);
			else
				d_tail =
						Integer2FreeStorage (&StyleSyntax, d_tail, NULL, style->layer,
																 DATABASE_Layer_ID);
		}
		...
		if (get_flags (style->set_flags, STYLE_BORDER_WIDTH))
			d_tail =
					Integer2FreeStorage (&StyleSyntax, d_tail, NULL,
															 style->border_width,
															 DATABASE_BorderWidth_ID);
		if (get_flags (style->set_flags, STYLE_HANDLE_WIDTH))
			d_tail =
					Integer2FreeStorage (&StyleSyntax, d_tail, NULL,
															 style->resize_width,
															 DATABASE_HandleWidth_ID);

		if (get_flags (style->flags, STYLE_STARTUP_DESK)
				&& get_flags (style->set_flags, STYLE_STARTUP_DESK))
			d_tail =
					Integer2FreeStorage (&StyleSyntax, d_tail, NULL, style->Desk,
															 DATABASE_StartsOnDesk_ID);
		/* ViewportXY -1 means that we use current viewport */
		if (get_flags (style->set_flags, STYLE_VIEWPORTX))
			d_tail =
					Integer2FreeStorage (&StyleSyntax, d_tail, NULL,
															 (get_flags (style->flags, STYLE_VIEWPORTX))
															 ? style->ViewportX : -1,
															 DATABASE_ViewportX_ID);
		if (get_flags (style->set_flags, STYLE_VIEWPORTY))
			d_tail =
					Integer2FreeStorage (&StyleSyntax, d_tail, NULL,
															 (get_flags (style->flags, STYLE_VIEWPORTY))
															 ? style->ViewportY : -1,
															 DATABASE_ViewportY_ID);

		if (get_flags (style->set_flags, STYLE_FRAME) && style->frame_name)
			if (get_flags (style->flags, STYLE_FRAME)
					&& strlen (style->frame_name) > 0)
				d_tail =
						String2FreeStorage (&StyleSyntax, d_tail, style->frame_name,
																DATABASE_Frame_ID);

		if (get_flags (style->set_flags, STYLE_WINDOWBOX)
				&& style->windowbox_name)
			if (get_flags (style->flags, STYLE_WINDOWBOX)
					&& strlen (style->windowbox_name) > 0)
				d_tail =
						String2FreeStorage (&StyleSyntax, d_tail,
																style->windowbox_name,
																DATABASE_Windowbox_ID);
		...
		if (get_flags (style->set_flags, STYLE_GRAVITY)) {
			...
			d_tail =
					Flag2FreeStorage (&StyleSyntax, d_tail,
														DATABASE_OverrideGravity_ID);
			if (*grav_tail)
				Flag2FreeStorage (&StyleSyntax, &((*grav_tail)->sub),
													GRAVITY_ID_START + style->gravity);
		}
	}
 ...
 */
int
WriteDatabaseOptions (const char *filename, char *myname,
											struct name_list *config, unsigned long flags)
{
	...
	if (config == NULL)
		return 1;
	if ((DatabaseConfigWriter =
			 InitConfigWriter (myname, &DatabaseSyntax, CDT_Filename,
												 (void *)filename)) == NULL)
		return 2;
	...
	WriteConfig (DatabaseConfigWriter, Storage, CDT_Filename,
							 (void **)&filename, flags);
	DestroyFreeStorage (&Storage);
	...
	if (Storage) {
		fprintf (stderr,
						 "\n%s:Database Config Writing warning: Not all Free Storage discarded! Trying again...",
						 myname);
		DestroyFreeStorage (&Storage);
